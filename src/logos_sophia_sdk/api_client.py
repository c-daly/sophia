...
from logos_sophia_sdk.configuration import Configuration
from logos_sophia_sdk.api_response import ApiResponse, T as ApiResponseT
import logos_sophia_sdk.models
from logos_sophia_sdk import rest
from logos_sophia_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(logos_sophia_sdk.models, klass)
