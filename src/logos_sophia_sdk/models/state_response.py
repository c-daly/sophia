...
class StateResponse(BaseModel):
    ...
    cursor: Optional[StrictStr] = Field(
        default=None, description="Cursor for retrieving the next page"
    )
    next_poll_after_ms: Optional[StrictInt] = Field(
        default=None, description="Suggested wait time before polling again"
    )
