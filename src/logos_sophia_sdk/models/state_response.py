...
class StateResponse(BaseModel):
    ...
    cursor: Optional[StrictStr] = Field(default=None, description="Cursor for retrieving the next page")
    next_poll_after_ms: Optional[StrictInt] = Field(default=None, description="Suggested wait time before polling again")
    __properties: ClassVar[List[str]] = ["states", "cursor", "next_poll_after_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "next_poll_after_ms": obj.get("next_poll_after_ms")
        })
        return _obj
