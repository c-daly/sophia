...
class CWMGImaginedData(BaseModel):
    """
    Payload for CWM-G (grounded/JEPA) outputs.
    """ # noqa: E501
    imagined: Optional[StrictBool] = True
    horizon_steps: Optional[StrictInt] = None
    frames: Optional[List[StrictStr]] = Field(default=None, description="URIs or identifiers for imagined frames")
    embeddings: Optional[List[Union[StrictFloat, StrictInt]]] = None
    assumptions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["imagined", "horizon_steps", "frames", "embeddings", "assumptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "imagined": obj.get("imagined") if obj.get("imagined") is not None else True,
            "horizon_steps": obj.get("horizon_steps"),
