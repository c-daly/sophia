...
class CWMGImaginedData(BaseModel):
    ...
    frames: Optional[List[StrictStr]] = Field(
        default=None, description="URIs or identifiers for imagined frames"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "imagined": (
                    obj.get("imagined") if obj.get("imagined") is not None else True
                ),
